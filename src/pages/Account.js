...
function Account() {
  ...
  const listNFT = async () => {
    ...
    const listing = {
      ...
      assetContractAddress: selectedNFT.contract.address,
            ...
            <Form>
              <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                ...
                <Form.Select aria-label="" onChange={handleListingCurrencyChange2} value={listingCurrency1}>
                  ...
                  <option value={NATIVE_TOKEN_ADDRESS}>MATIC (MATIC)</option>
                </Form.Select>
            ...
            ? newNFT.map((nft) => {
              return (
                <div className="rounded-lg w-[250px] bg-slate-800 overflow-hidden cardNFT"   >
                  ...
                  {/* btn create  */}
                  <div  className={`d-flex flex-row-reverse ${address === inputString ? "" : "hiddenBtnCreate"}`}  >
                    <Button
                      variant="primary"
