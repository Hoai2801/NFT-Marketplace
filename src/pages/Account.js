                        ...
                        <tbody>
                            <tr className="align-middle">
                                ...
                                <td>
                                    ...
                                    <img src={nfts.metadata.image} alt="" className=" object-cover"/>
                                    </div>
                                </td>
                                <td>{nfts.supply}</td>
                                <td>
                                    <button onClick={() => listNFT(nfts.metadata.id)} className="border rounded-lg p-2 bg-blue-400">List</button>
                                    <button onClick={() => listNFT(nfts.metadata.id)} className="border rounded-lg p-2 bg-blue-400">Aution</button>
                                </td>
                            </tr>
                        </tbody>
                )}
