...
function Account() {
  ...
  useEffect(() => {
    if (url === "/account/undefined") {
      if (address != null) setUrl(`/account/${address}`);
    }
  }, [url]);
  ...
  const handleBuyoutPriceChange = (event) => {
    ...
    setErrors({
      ...errors,
      buyoutPrice: isNaN(value) ? "Buyout price must be a number" : "",
    });
  };
  ...
  const handleQuantityChange = (event) => {
    ...
    setErrors({
      ...errors,
      quantity: isNaN(value) ? "Quantity must be a number" : "",
    });
  };
  ...
  const handleReservePriceChange = (event) => {
    ...
    setErrors({
      ...errors,
      reservePrice: isNaN(value) ? "Reserve price must be a number" : "",
    });
  };
  ...
  const handleAuctionDurationChange = (event) => {
    ...
    setErrors({
      ...errors,
      auctionDuration: isNaN(value) ? "Auction duration must be a number" : "",
    });
  };
  ...
  const handleCreateAuction = () => {
    ...
    if (!listingCurrency) {
      setErrors((prevErrors) => ({
        ...prevErrors,
        listingCurrency: "Listing currency is required",
      }));
      isValid = false;
    }
    ...
    if (!buyoutPrice || isNaN(buyoutPrice)) {
      setErrors((prevErrors) => ({
        ...prevErrors,
        buyoutPrice: "Buyout price is required",
      }));
      isValid = false;
    }
    ...
    if (!reservePrice || isNaN(reservePrice)) {
      setErrors((prevErrors) => ({
        ...prevErrors,
        reservePrice: "Reserve price is required",
      }));
      isValid = false;
    }
  ...
  const handleListingPriceChange2 = (event) => {
    ...
    setErrors1({
      ...errors1,
      listingPrice: isNaN(value) ? "Listing price must be a number" : "",
    });
  };
  ...
  const handleQuantityChange2 = (event) => {
    ...
    setErrors1({
      ...errors1,
      quantity1: isNaN(value) ? "Quantity must be a number" : "",
    });
  };
  ...
  const handleCreateDirectListing2 = () => {
    ...
    if (!listingCurrency1) {
      setErrors1((prevErrors) => ({
        ...prevErrors,
        listingCurrency1: "Listing currency is required",
      }));
      isValid = false;
    }
    ...
    if (!listingPrice || isNaN(listingPrice)) {
      setErrors1((prevErrors) => ({
        ...prevErrors,
        listingPrice: "Listing price must be a number",
      }));
      isValid = false;
    }
    ...
    if (!quantity1 || isNaN(quantity1)) {
      setErrors1((prevErrors) => ({
        ...prevErrors,
        quantity1: "Quantity must be a number",
      }));
      isValid = false;
    }
  ...
  return (
    <section className="container-master-1">
      ...
      <div className="px-20 mt-5">
                ...
                return (
                  <div className="rounded-lg w-[250px] bg-slate-800 overflow-hidden">
                    ...
                    <div className="h-[90px] w-full pl-5 text-white flex gap-1 flex-col my-0 pr-2">
                      ...
                      <span className="font-medium text-[16px] my-0">
                        Type: {nft.tokenType}
                      </span>
                    ...
                    >
                      ...
                      <Modal.Body>
                        <Form>
                          ...
                          >
                            ...
                            <Form.Select
                              aria-label=""
                              onChange={handleListingCurrencyChange2}
                              value={listingCurrency1}
                            >
                              <option value="">Select a currency</option>
                              <option value="matic">MATIC (MATIC)</option>
                            </Form.Select>
                            {errors1.listingCurrency1 && (
                          ...
                          >
                            ...
                            <span
                              ...
                              style={{ fontSize: "14px ", color: "gray" }}
                            >
                              The price per token a buyer can pay to instantly
                              buyout the auction.
                            </span>
                          </Form.Group>
                          <Form.Group
                      ...
                      <Modal.Footer>
                        ...
                        <Button
                          variant="primary"
                          onClick={handleCreateDirectListing2}
                        >
                          Create Direct Listing
                        </Button>
                      </Modal.Footer>
                    ...
                    <Modal
                      show={show2}
                      onHide={handleClose2}
                      className="mt-[80px] overflow-scroll"
                      ...
                      <Modal.Body>
                        <Form>
                          ...
                          >
                            ...
                            <Form.Select
                              aria-label=""
                              onChange={handleListingCurrencyChange}
                              value={listingCurrency}
                            >
                              <option value="">Select a currency</option>
                              <option value="matic">MATIC (MATIC)</option>
                            </Form.Select>
                            {errors.listingCurrency && (
                              <div className="text-danger">
                                {errors.listingCurrency}
                              </div>
                            )}
                          ...
                          >
                            ...
                            <span
                              ...
                              style={{ fontSize: "14px ", color: "gray" }}
                            >
                              The minimum price per token necessary to bid on
                              this auction.
                            </span>
                          </Form.Group>
                          <Form.Group>
                ...
                <>
                  <div
                    ...
                    className={`${listing.status == 3 ? "hidden" : ""} ${
                      listing.creatorAddress == inputString ? "" : "hidden"
                    }`}
                  >
                    <Link to={`/nft/${index}`}>
                      <Card
        ...
        {/* Auction */}
        <div
          className={`${option === "auc" ? "" : "hidden"} w-full flex gap-3`}
        >
          {auction
